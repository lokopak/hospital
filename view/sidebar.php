...
<nav class="side-navbar">
    <div class="sidebar-header d-flex align-items-center justify-content-center p-3 mb-3">
        <div class="sidenav-header-inner text-center"><img class="img-fluid rounded-circle avatar mb-3" src="/assets/images/person-no-image.png" alt="person">
            <?php if (null !== $usuario) : ?>
    ...
    <ul class="list-unstyled">
        ...
        <li class="sidebar-item <?= (strpos($url, "/empleados") !== false ? 'active' : '') ?>">
            ...
            <?php endif; ?>
            <ul class="collapsed list-unstyled <?= (strpos($url, "/empleados") === false ? 'collapse' : '') ?>" id="empleadosDropdown">
                <li <?= (strcmp($url, "/empleados/index.php") === 0 ? 'class="active"' : '') ?>><a class="sidebar-link" href="/empleados/index.php">Listado de empleados</a></li>
                <li <?= (strpos($url, "/empleados/crear.php") !== false ? 'class="active"' : '') ?>><a class="sidebar-link" href="/empleados/crear.php">Alta nuevo empleado</a></li>
            </ul>
        ...
        <li class="sidebar-item <?= (strpos($url, "/pacientes") !== false ? 'active' : '') ?>">
            ...
            <ul class="collapsed list-unstyled <?= (strpos($url, "/pacientes") === false ? 'collapse' : '') ?>" id="pacientesDropdown">
                <?php
                if (ControlAcceso::tieneAcceso('PACIENTES@VER')) : ?>
                    <li <?= (strcmp($url, "/pacientes/index.php") === 0 ? 'class="active"' : '') ?>><a class="sidebar-link" href="/pacientes/index.php">Listado de pacientes</a></li>
                <?php endif; ?>
                <?php
                if (ControlAcceso::tieneAcceso('EMPLEADOS@EDITAR')) : ?>
                    <li <?= (strcmp($url, "/pacientes/crear.php") === 0 ? 'class="active"' : '') ?>><a class="sidebar-link" href="/pacientes/crear.php">Alta nuevo paciente</a></li>
                <?php endif; ?>
            </ul>
        </li>
        <li class="sidebar-item <?= (strpos($url, "/informes") !== false ? 'active' : '') ?>">
            ...
            <?php endif; ?>
            <ul class="collapsed list-unstyled <?= (strpos($url, "/informes") === false ? 'collapse' : '') ?>" id="informesDietasDropdown">
                <li <?= (strcmp($url, "/informes/index.php") === 0 ? 'class="active"' : '') ?>><a class="sidebar-link" href="/informes/index.php">Informes</a></li>
            </ul>
        </li>
        <li class="sidebar-item <?= (strpos($url, "/dietas") !== false ? 'active' : '') ?>">
            ...
            <ul class="collapsed list-unstyled <?= (strpos($url, "/dietas") === false ? 'collapse' : '') ?>" id="dietasDropdown">
                <li <?= (strcmp($url, "/dietas/index.php") === 0 ? 'class="active"' : '') ?>><a class="sidebar-link" href="/dietas/index.php">Ver dietas</a></li>
            </ul>
        </li>
    </ul>
</nav>