...
namespace Dotpak\Hospital\Informe\Controller;

use Dotpak\Hospital\Informe\Model\TablaInforme;
...
class InformeController
{
    ...
    public function index()
    {
        ...
        $informes = $this->tabla->buscarTodos(['id', 'idNutricionista', 'idPaciente', 'idCelador', 'dieta', 'fecha', 'desayuno', 'comida1', 'comida2', 'comida3', 'merienda', 'cena1', 'cena2', 'cena3', 'fechaModificacion', 'ultimoEditor']);
